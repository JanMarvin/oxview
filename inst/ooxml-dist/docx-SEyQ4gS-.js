...
import { B as t, Ct as n, Et as r, Jt as i, R as a, Yt as o, a as s, it as c, mt as l, q as u, z as d } from "./line-metrics-Baz31mML.js";
import { C as f, E as p, S as m, T as h, _ as g, a as _, b as v, c as y, d as b, f as x, g as ee, h as te, i as S, l as C, m as ne, n as re, o as ie, p as ae, r as oe, s as se, t as ce, u as le, v as w, w as ue, x as de, y as T } from "./canvas-viewer-mechanics-CqxKRGCp.js";
import { a as fe, c as pe, i as me, o as he, r as ge, s as _e, t as ve } from "./bounded-raw-part-cache-C6ro6Ezf.js";
import { C as ye, S as be, _ as E, a as xe, b as Se, c as Ce, d as we, f as Te, g as Ee, h as De, l as Oe, m as ke, n as D, o as Ae, p as je, s as Me, t as O, v as k, w as Ne, x as A, y as Pe } from "./document-pull-client-Ux4a_ax8.js";
import { an as j, mn as Fe, pn as Ie } from "./plot-area-frame-Dg1VIpUU.js";
import { n as Le } from "./renderer-module-contract-0bO_5SC0.js";
import { n as Re, r as M, t as N } from "./highlight-rect-BqcZMHUE.js";
...
async function He(e, t = 30 * 1024 * 1024) {
	...
	for (let o of e) try {
		...
		let e = o.odttf ? ze(o.bytes, o.fontKey ?? "") : o.bytes, { face: s, isNew: c } = pe(`embedded:${Ve(o.family, o.weight, o.style, e)}`, n, () => {
	...
	return i.length > 0 && await he(Promise.allSettled(i.map((e) => e.load())).then((e) => (e.forEach((e, t) => {
...
function ot(e, t, n, r, i, a) {
	...
	let s, c = !1, l, u;
	if (o === "chart") {
		let t = "drawing" in e ? V(e.drawing, "chart").resourceKey : e.placement.resourceKey, n = i.resolve(t, "chart"), r = b(n.model, a);
...
function st(e, t, n, r, i = {}) {
	...
	let a = z(i.maxTextCharacters), o = Ee(e, t);
...
var U = class e {
	...
	constructor(e, t, n, r) {
		this._worker = e, this._mode = t, Se(this, n), this._bridge = new f(this._worker, {
		...
		try {
			...
			try {
				...
				if (u._mode === "main" && r.math && u._document && Ae(u._document) && (d = await Me(u._document, r.math)), u._mode === "main" && u._document && u._source) {
					...
					let t = e.services;
					xe(u._source, t, e.defaultCurrentDateMs).layoutVariants.defaultLayout;
				}
	...
	destroy() {
		this._bridge.terminate(), this._document = null, this._source = null, this._meta = null, A(this).services = null, this._bookmarkPages = null, this._rawParts.clear(), this._embeddedFontFaces.length > 0 && (Ue(this._embeddedFontFaces), this._embeddedFontFaces = []), this._googleFontFaces.length > 0 && (fe(this._googleFontFaces), this._googleFontFaces = []), this._localMetricFontFaces.length > 0 && (Ne(this._localMetricFontFaces), this._localMetricFontFaces = []), r(this._fetchImage), n(this._fetchImage);
	}
	async getImage(e, t) {
...
var J = class {
	...
	async find(e, t = {}) {
		...
		for (let n = 0; n < a; n++) {
			let r = o.get(n) ?? [], i = ne(r);
			for (let a of te(i, e, t)) {
	...
	next() {
		return this._active = x(this._active, this._matches.length), this._activePublic();
	}
	prev() {
...
var Q = Symbol("DocxViewer.borrowedDocument"), dt = class e {
	...
	constructor(e, t = {}) {
		...
		let n = t[Q];
		this._borrowed = n !== void 0, this._mode = C("DocxViewer", t.mode, n), this._documentOwner = new _("DocxViewer", n ?? null, !1);
		...
		this._hostWindow = r, this._canvasMount = new ce(e, {
			wrapperCssText: "position:relative;display:inline-block;vertical-align:top;",
			forceDisplayBlock: !0
		}), this._wrapper = this._canvasMount.wrapper, this._renderDispatcher = new S(e, this._mode === "worker"), this._errorRouter = new oe("DocxViewer", t.onError);
		let i = new re(this._wrapper, t.enableTextSelection === !0, t.enableElementSelection === !0);
	...
	async setScale(e) {
		let t = ee(e, this._zoomMin(), this._zoomMax()), n = t !== this.getScale();
	...
	_redrawElementOutline() {
		...
		if (!e || !t || e.pageIndex !== this._currentPage) {
			y(this._elementLayer, null);
			return;
		}
		let n = t.pageSize(e.pageIndex);
		y(this._elementLayer, {
	...
	constructor(e, t = {}) {
		...
		this._borrowed = n !== void 0, n ? (this._documentOwner = new _("DocxScrollViewer", n, !1), this._mode = C("DocxScrollViewer", t.mode, n)) : (this._documentOwner = new _("DocxScrollViewer"), this._mode = C("DocxScrollViewer", t.mode, void 0)), this._wrapper = document.createElement("div"), this._wrapper.style.cssText = "position:relative;width:100%;height:100%;overflow:hidden;", this._scrollHost = document.createElement("div"), this._scrollHost.style.cssText = "position:absolute;inset:0;overflow:auto;", this._scrollHost.style.scrollbarGutter = "stable", t.background && (this._scrollHost.style.background = t.background), this._spacer = document.createElement("div"), this._spacer.style.cssText = "position:absolute;top:0;left:0;width:1px;height:0;pointer-events:none;", this._scrollHost.appendChild(this._spacer), this._wrapper.appendChild(this._scrollHost), this._container.appendChild(this._wrapper), t.enableTextSelection && (t.onSelectionContextChange || t.enableElementSelection) && (this._selectionChangeListener = () => this._emitSelectionContextChange(), this._wrapper.ownerDocument.addEventListener("selectionchange", this._selectionChangeListener)), t.enableElementSelection && (this._elementClickListener = (e) => {
			...
			this._pendingZoomAnchor = Number.isFinite(n) && Number.isFinite(r) ? {
				x: n,
				y: r
			} : null, this.setScale(de(this._scale, e.deltaY));
	...
	_acquireSlot() {
		...
		let a = ie(t, this._opts.enableElementSelection === !0);
	...
	_recycleSlot(e, t) {
		this._slots.delete(e), t.dispatcher.destroy(), this._destroyed || (t.dispatcher = new S(t.canvas, this._mode === "worker")), t.textLayer && (t.textLayer.innerHTML = "", t.textLayer.style.transform = "", t.textLayer.style.transformOrigin = ""), t.highlightLayer.innerHTML = "", t.highlightLayer.style.transform = "", t.highlightLayer.style.transformOrigin = "", y(t.elementLayer, null), t.renderedPage = -1, t.renderedScale = -1, t.wrapper.remove(), this._free.push(t);
	}
	_positionSlot(e, t, n) {
	...
	setScale(e) {
		...
		let g = Math.max(0, h.totalHeight - this._scrollHost.clientHeight), _ = (h.offsets[u] ?? 0) + f * (this._heights[u] || 0), y = l < (s.offsets[0] ?? 0) ? c : _ - o;
		if (this._scrollHost.scrollTop = Math.min(g, Math.max(0, y)), i) {
			let e = Math.max(0, (this._spacer.offsetWidth || 0) - this._scrollHost.clientWidth);
			this._scrollHost.scrollLeft = v(m, i.x - p, a, r, { maxScroll: e });
		}
