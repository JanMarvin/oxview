...
var J = class e {
	...
	async getResourceMetrics() {
		...
		return g(e, async (e) => (await this._bridge.request((e) => ({
			kind: "resourceUsage",
			id: e
...
var Ut = Symbol("PptxViewer.borrowedPresentation"), Wt = {
	...
	_onHyperlinkClick(e) {
		...
		if (t.kind === "external") {
			T(t.url, void 0, this.hostWindow);
			return;
		}
