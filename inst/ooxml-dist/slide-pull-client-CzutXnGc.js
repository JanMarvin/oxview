import { A as e, At as t, Bt as n, C as r, D as i, Dt as a, Ft as o, Gt as s, Ht as c, It as l, K as u, Lt as d, M as f, Mt as p, N as m, O as h, Ot as g, Pt as _, Rt as v, S as y, St as b, Tt as x, Ut as S, Vt as C, Wt as w, _ as T, _t as E, c as D, ct as O, d as k, f as A, g as j, gt as M, h as N, ht as P, i as F, j as I, m as L, mt as R, n as z, p as B, pt as V, qt as H, r as U, s as W, u as ee, vt as G, w as K, wt as q, xt as te, y as ne, yt as re, zt as ie } from "./line-metrics-Baz31mML.js";
import { a as ae, c as oe, d as se, i as ce, l as le, n as ue, o as de, r as fe, s as pe, t as me, u as he } from "./line-distribute-BBGvvwLt.js";
import { S as ge, _ as _e, h as ve, hn as ye, k as be, ln as xe, mn as Se, rn as J, sn as Ce, un as we, v as Te, w as Ee } from "./plot-area-frame-Dg1VIpUU.js";
import { A as De, F as Oe, I as ke, L as Ae, M as je, N as Me, P as Ne, j as Pe } from "./three-d-BYiWCNlz.js";
import { k as Fe } from "./renderer-DuopJE1K.js";
import { i as Ie } from "./resource-measurement-DRLp4nFt.js";
...
function ln(e, t, n, r, i, a, o = "fill", s = on) {
	...
	for (let o of t) {
		let t = o.codePointAt(0) ?? 0, l = A(t), p = e.measureText(o).width + a, m = l === "Tr" ? ee(t) : null, h = l === "Tr" && m === null && L(t), g = l === "U" || l === "Tu" || m !== null || h;
		if (B(t) && s(t)) {
			let t = n + f + p / 2;
...
async function gn(e, t) {
	...
	if (n.length !== 0) {
		...
		for (let e of n) if (!pn.has(e.nodes)) try {
			let n = await t.mathMLToSvg(G(e.nodes, e.display)), r = await M(n, "#000000");
			pn.set(e.nodes, {
				raster: r,
				widthEm: n.widthEm,
				ascentEm: n.ascentEm,
...
function An(e, t, n, r, i, a, o) {
	...
	for (let c of t.paragraphs) {
		...
		for (let n of c.runs) {
			...
			e.font = Z(n.bold ?? c.defBold ?? t.defaultBold ?? !1, n.italic ?? c.defItalic ?? t.defaultItalic ?? !1, r, i, o);
...
function jn(e) {
	for (let t of e) if (K(t.codePointAt(0) ?? 0)) return !0;
	return !1;
}
function Mn(e) {
	let t = 0;
...
function Fn(e, t, n, i, a, o, s, c = !1, l = !1, u = 1, d, f = {
	...
	for (let [n, s] of t.runs.entries()) {
		...
		let p = s.fontSize == null ? i : s.fontSize * J * o * u, m = _n(s.fontFamily ?? t.defFontFamily ?? null, f), _ = s.fontFamilyEa ? _n(s.fontFamilyEa, f) : null, C = s.fontFamilySym ? _n(s.fontFamilySym, f) : null, w;
		w = s.color ? X(s.color) : s.hyperlink && f.themeHlinkColor ? X(f.themeHlinkColor) : a;
		let E = s.bold ?? t.defBold ?? c, D = s.italic ?? t.defItalic ?? l, M = Z(E, D, p, m, f), P = _ ? Z(E, D, p, _, f) : M;
		e.font = M;
		let V = s.caps, H = g.get(s) ?? s.text;
		(V === "all" || V === "small") && (H = H.toUpperCase());
		let U = s.fieldType === "slidenum" && d !== void 0 ? String(d) : H, W = s.underline || s.hyperlink !== void 0, ee = s.strikeDouble === !0, G = s.letterSpacing == null ? 0 : s.letterSpacing * J * o, q = {
			strikeDouble: ee,
			letterSpacingPx: G,
		...
		for (let i of te) {
			...
			e.font = M;
			let a = R(i, M, G, n), o = /^\s+$/.test(i), c = /[-]/;
			if (c.test(i) && (C != null || he(m))) {
				let t = C ?? m;
				for (let r of i) {
					let i = r, a = M;
					if (c.test(r)) {
						let e = se(r, t);
						e === r ? a = Z(E, D, p, t, f) : (i = e, a = Z(E, D, p, "sans-serif", f));
					}
					e.font = a, !F(R(i, a, G, n)) && x > 0 && L(), z(i, a, p, w, W, s.strikethrough, s.baseline ?? void 0, q);
				}
				continue;
			}
			if (jn(i) && (!N(i) || t.eaLnBrk === !1)) {
				let r = [];
				for (let t of i) {
					let n = K(t.codePointAt(0) ?? 0) && _ != null, i = n ? P : M, a = n ? _ : m;
					e.font = i, r.push({
						ch: t,
						w: Q(e, t, 0),
						font: i,
				...
				if (t.eaLnBrk === !1) {
					let e = b.segments.at(-1), t = !!e && !e.isTab && !e.math && e.sourceRunId === n, i = r.reduce((e, t) => e + t.w, 0) + Math.max(0, r.length - 1) * G + (t && r.length > 0 ? G : 0);
					x > 0 && !F(i) && L();
				...
				let a = r;
				for (; a.length > 0;) {
					let e = Number.isFinite(v()) ? v() - I() : x, t = b.segments.at(-1), r = !!t && !t.isTab && !t.math && t.sourceRunId === n, i = Jt(a, e, v(), h, G, r);
					if (i === 0) {
						if (x > 0) {
							L();
							continue;
			...
			if (N(i)) {
				let t = y(i, {
					cjk: !0,
					kinsoku: h
				}), r = _ != null && P !== M, a = (e) => r && K(e.codePointAt(0) ?? 0), o = (t) => {
					let r = 0, i = b.segments.at(-1), o = !!i && !i.isTab && !i.math && i.sourceRunId === n, s = "", c = null, l = () => {
						s !== "" && (e.font = c ? P : M, r += Q(e, s, G), o && (r += G), o = !0, s = "");
					};
					for (let e of t) {
						let t = a(e);
			...
			if (F(a)) z(i, M, p, w, W, s.strikethrough, s.baseline ?? void 0, q), o && (S = !0);
			else if (o) x > 0 && L();
			else if (a > v()) {
				x > 0 && L();
				for (let t of i) e.font = M, !F(R(t, M, G, n)) && x > 0 && L(), z(t, M, p, w, W, s.strikethrough, s.baseline ?? void 0, q);
			} else if (!S) z(i, M, p, w, W, s.strikethrough, s.baseline ?? void 0, q);
			else {
				...
				(o || c) && B() || L(), z(i, M, p, w, W, s.strikethrough, s.baseline ?? void 0, q);
			}
		}
	}
	return m.push(b), m;
...
function zn(e, t, n, r, i, a) {
	...
	if (!p) return;
	let { ax: m, ay: h } = Rn(n.algn ?? "tl", r, i, o, s), g = m + Y(n.tx ?? 0, a), _ = h + Y(n.ty ?? 0, a);
...
function $n(e, t, n, r, i, a, o, s, c, l, u) {
	...
	for (let n of t.paragraphs) {
		let t = Fn(e, n, Infinity, n.defFontSize == null ? v : n.defFontSize * J * c, n.defColor ? X(n.defColor) : l, c, 0, g, _, 1, void 0, u, 0);
...
function sr(e, t, n, r, i, a, o, s) {
	let c = st(e, i, a).corners, l = (o > 0 ? Pe(c, o / i, o / a) ?? c : c).map((e) => ar(t, n + e.x, r + e.y)), u = l.map(([e]) => e), d = l.map(([, e]) => e), f = Math.min(...u), p = Math.min(...d), m = Math.max(...u), h = Math.max(...d), [g, _] = ir[s ?? "b"], v = je(c, g, _);
	return {
		bbox: {
			x: f,
			y: p,
...
function lr(e, t, n, r, i, a, o, s, c, l = !0, u = r) {
	...
	t.shadow && p ? (e.save(), e.setTransform(m), y = !Ne(e, g, i, t.shadow, s, d, f, Math.atan2(c.b, c.a) * 180 / Math.PI, a), e.restore()) : t.shadow && (y = !0), t.reflection && p && (e.save(), e.setTransform(m), Oe(e, g, i, t.reflection, s, d, f), e.restore()), y ? Bn(e, t.shadow ?? null, o) : t.glow && Vn(e, t.glow, o), t.softEdge && p ? (e.save(), e.setTransform(m), ke(e, g, i, t.softEdge, s, d, f, _), e.restore()) : n(e), (y || t.glow) && Hn(e), t.innerShadow && l && p && (e.save(), e.setTransform(m), Me(e, v, i, t.innerShadow, s, d, f), e.restore());
}
function ur(e, t, n, r = "#000000", i, a = {
	...
	let b = new Set([
		...
		r.beginPath(), t.custGeom && t.custGeom.length > 0 ? dr(r, t.custGeom, o, s, c, l) : de(r, v, o, s, c, l, t.adj, t.adj2, t.adj3, t.adj4), h && v !== "arc" && (r.fillStyle = h, v === "donut" || v === "smileyface" || v === "frame" ? r.fill("evenodd") : r.fill(), i || _()), g && g();
		...
		if (t.stroke && (b.has(v) || x.has(v))) {
			...
			a && o && Er(e, i.start, i.end, t.stroke, a, n, t.rotation), t.stroke.tailEnd && ue(e, i.end.x, i.end.y, i.end.angle, t.stroke.tailEnd, t.stroke, n, r), t.stroke.headEnd && ue(e, i.start.x, i.start.y, i.start.angle, t.stroke.headEnd, t.stroke, n, r);
			return;
		}
...
function gr(e, n, r, i, a, o, s, c = null, l = 0, u = !1, d = !1, f = "#000000", p, m = {
	...
	let C = Y(n.lIns, s), w = Y(n.rIns, s), T = Y(n.tIns, s), E = Y(n.bIns, s), D = n.wrap !== "none", O = n.autoFit === "sp" ? D && An(e, n, a, C, w, s, m) : D, k = Math.max(1, n.numCol ?? 1), A = Y(n.spcCol ?? 0, s), j = n.defaultBold ?? !1, M = n.defaultItalic ?? !1, N = c ?? f, P = (t) => {
		...
		for (let u = 0; u < n.paragraphs.length; u++) {
			...
			let V = k > 1 ? (a - C - w - (k - 1) * A) / k : a - C - w, H = r + C + f, U = r + C + f + _, W = V - f - h, ee = Fn(e, d, O ? W : Infinity, v, b, s, f, j, M, t, p, m, kn(x, _)), G = d.spaceBefore == null ? 0 : d.spaceBefore / 100 * J * s * t, K = d.spaceAfter == null ? 0 : d.spaceAfter / 100 * J * s * t;
			for (let t = 0; t < ee.length; t++) {
				let r = ee[t], i = t === 0, a = t === ee.length - 1, l = 0, f = 0;
				...
				let b = h + (a ? K : 0), S = i && u > 0 ? G : 0, C = i ? kn(x, _) : 0, w = r.segments.some((e) => e.text && e.text.length > 0 || e.math != null), T = i && w ? R : null;
				o.push({
					line: r,
					linePx: b,
					lineHeight: h,
	...
	let W = H, ee = k > 1 ? (a - C - w - (k - 1) * A) / k + A : 0, G = Math.max(0, B - T - E), K = F[F.length - 1], q = K ? Math.max(0, K.linePx - K.lineHeight) : 0, te = I - q, ne = o === 0 || te <= G + .5, re = k > 1 && !ne ? Math.ceil(F.length / k) : F.length, ie = 0, ae = 0;
	for (let c of F) {
		...
		k > 1 && ie < k - 1 && ae >= re && (ie++, ae = 0, H = W), H += p, ae++;
		let T = (n.rtlCol ? k - 1 - ie : ie) * ee, E = c.textX + T, D = c.bulletX + T, O = c.textMaxW, A = c.para.rtl === !0, j = A || Kt(u.segments), M = u.segments.some((e) => e.isTab);
		if (M) {
		...
		let U = C === "just" || C === "justLow" ? "just" : C === "thaiDist" ? "thaiDist" : C === "dist" ? "dist" : null, G = w || (u.endsWithBreak ?? !1), K = (U && !j && !M ? Xt(u.segments, O - g, N, U, G) : null) ?? u.segments, q = j ? qt(u.segments, A) : null, te = (e, t) => {
		...
		for (let t = 0; t < ne; t++) {
			let n = q ? q.order[t] : t, c = K[n], u = q ? q.rtl[n] : !1;
			...
			if (c.highlight && c.text) {
				...
				dn(e, B, y, t, c.sizePx, c.highlight, c.color);
			}
			...
			}, C = (t) => Q(e, t, b), w = p && p.length > 0 ? Rt([...c.text], p, g, C) : null, T = [...c.text], E = !!p && p.length === T.length - 1 && T.length > 1, D = (e, t) => {
				if (v) {
					let n = E ? b + g : b;
					un(e, c.text, B, y, c.sizePx, n, t);
					return;
				}
				if (E) {
			...
			if (x) {
				let t = x.dir * Math.PI / 180, n = Y(x.dist, s);
				e.save(), e.shadowColor = X(x.color, x.alpha), e.shadowBlur = Y(x.blur, s), e.shadowOffsetX = Math.cos(t) * n, e.shadowOffsetY = Math.sin(t) * n;
			}
			D(e, "fill"), x && e.restore();
			let k = c.outline;
			k && k.width > 0 && (e.save(), e.lineWidth = Math.max(.5, Y(k.width, s)), e.strokeStyle = k.color ? `#${k.color}` : c.color, e.lineJoin = "round", D(e, "stroke"), e.restore()), e.font = c.font;
			...
			}), c.underline && It(e, B, y, A + d, c.sizePx, c.underlineColor ?? c.color, c.underlineStyle, m.dpr), c.strikethrough) {
...
function Cr(e, t, n = Sr(t)) {
	return g("base", e.posterPath, n, async () => {
		...
		return {
			bitmap: await we(n.type === r ? n : new Blob([n], { type: r })),
			owned: !0
		};
	}).then((e) => {
...
async function wr(e, t, n, r, i) {
	if (i) try {
		let a = t.mimeType === "image/svg+xml", s = xe(t.mimeType, t.srcRect, t.width / J, t.height / J);
		if (!s) return;
		let { widthPt: c, heightPt: u } = s, d;
		if (re(t)) try {
			d = await q(t.svgImagePath, i);
		} catch {
			d = a ? await q(t.imagePath, i) : await Ie(t.imagePath, t.mimeType, t.duotone, i, {
				widthPt: c,
				heightPt: u
			});
		}
		else d = a ? await q(t.imagePath, i) : await Ie(t.imagePath, t.mimeType, t.duotone, i, {
			widthPt: c,
			heightPt: u
		});
		if (!d || r()) return;
		...
		}, W = n * B, ee = !!(t.shadow || t.innerShadow || t.glow || t.softEdge || t.reflection), G = (e) => L(e, "#000");
		lr(e, t, S && ee ? cr(F, R, U.bbox, {
			w: e.canvas.width || 0,
			h: e.canvas.height || 0
		}) : F, S && ee ? cr(G, R, U.bbox, {
			w: e.canvas.width || 0,
			h: e.canvas.height || 0
		}) : G, U.bbox, U.anchor, n, W, R), e.restore();
	} catch (e) {
		if (Se(e)) throw e;
	}
}
async function Tr(e, t, n, r, i, a, o) {
	...
	r() || (e.save(), Or(e, t, n), d ? e.drawImage(d, s, c, l, u) : (e.fillStyle = t.mediaKind === "video" ? "#111" : "#f0f0f0", e.fillRect(s, c, l, u)), a || Ut(e, s + l / 2, c + u / 2, l, u, "paused"), e.restore());
}
function Er(e, t, n, r, i, a, o) {
...
async function Fr(e, t, n, r, i = {}, o, s) {
	let c = (jr.get(e) ?? 0) + 1;
	jr.set(e, c);
	let l = () => jr.get(e) !== c, u = i.width ?? ((P(e) ? e.offsetWidth : 0) || 960), d = u / n, f = Math.round(u), p = Math.round(r * d), m = i.dpr ?? R(), h = Ae(f * m, p * m), g = h.clamped ? m * h.scale : m;
	...
	if (await In(_, t.background, f, p, d, l, i.fetchImage), l() || (i.math && await gn(t, i.math), l())) return e;
	let b = t.slideNumber;
	for (let e of t.elements) if (e.type === "picture" && i.fetchImage) {
		let t = e, n = t.mimeType === "image/svg+xml";
		if (re(t)) q(t.svgImagePath, i.fetchImage).catch(() => void 0);
		else if (n) q(t.imagePath, i.fetchImage).catch(() => void 0);
		else {
			let e = xe(t.mimeType, t.srcRect, t.width / J, t.height / J);
			if (!e) continue;
	...
	if (i.fetchImage) {
		...
		if (r.size > 0 || o.size > 0) {
			let t = [...r].map((e) => {
				...
				try {
					let r = xe(t.mimeType, t.srcRect, 72, 72);
					if (!r) {
						x.set(e, null);
						return;
					}
					let i = () => t.mimeType === "image/svg+xml" ? t.duotone ? Promise.resolve(null) : q(t.imagePath, n) : Ie(t.imagePath, t.mimeType, t.duotone, n, {
						widthPt: r.widthPt,
						heightPt: r.heightPt,
...
function Vr(e) {
	...
	let n = t.slides.map((e, t) => {
		...
		return Object.freeze({
			...
			notes: n.notes,
			hidden: n.hidden,
			mediaElements: Object.freeze(n.mediaElements.map((e) => Br(e, t)))
		});
...
//#endregion
export { Vr as a, Pr as c, Rr as i, Ut as l, Gr as n, Ir as o, Hr as r, Mr as s, Wr as t };
